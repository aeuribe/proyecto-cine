...
class CarteleraCan(tk.Toplevel):
    ...
    def create_widgets(self):
        ...
        mensaje_cartelera = ttk.Label(mensaje_frame, text="Selecciona la película en donde deseas cancelar el asiento!", font=("Roboto Light", 24),foreground="red")
        ...
        for i, pelicula in enumerate(self.peliculas):
            ...
            boton_pelicula = ttk.Button(self, image=imagen_tk, command=lambda p=pelicula: self.app.seleccionar_pelicula_cancelar(p))
